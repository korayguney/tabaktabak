...
$yemek1 = mysql_query ("select * from yemekler where kalori between '".$_SESSION["kalori2"]."' - 100 and '".$_SESSION["kalori2"]."' + 100 limit 5");
...
$i = 0 ; 
 ...
 while($yaz = mysql_fetch_array($yemek1))
	...
	echo '<br>';
	echo '<br>';
	echo '<p><a href="uye_hesap.php" class="buton"> HESABIM </a></p>';
	echo '<br>';
	echo '<br>';
	echo '<br>';
