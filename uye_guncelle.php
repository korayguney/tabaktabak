...
<p><fieldset></p>
<br>
<?php echo '<font size="5"><div align="left">HOŞGELDİN </div></font>'.$kadi; ?>
<br><br><br>
<p><legend><font face="tahoma" size="5" color="maroon"><b>Kayıt Masası</b></font></legend></p>
<br>
<form action="uye_guncelle_kontrol.php" method="post">
<br>
...
<input type="radio" name="aktivite" value="orta_hareketli" > Orta hareketli (Haftada 3-5 gün spor)<br>
...
<input type="radio" name="kalori" value="kilo_vermek">  Haftada 1 kilo vermek <br>
